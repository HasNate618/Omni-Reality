"""Pack arithmetic for listings + layout-mode planner for room corner fill.

Pack functions (ours, spec §7.1): pure functions over listing extents for
place_item/offset_m. Layout-mode (theirs): LayoutPlanner for corner furniture
placement with canned and model-chosen arrangements.
"""
...
# ---------------------------------------------------------------------------
# Layout mode (theirs: guide/tutorial room corner fill)
# ---------------------------------------------------------------------------
