...
- `docs/omni-guided-tutorials.md`: persistent image-grounded tutorials, guide commands, and mask highlighting.
...
- `docs/omni-tracking-highlight.md`: model highlight tool → SAM2 video track → 10 s Quest overlay.
